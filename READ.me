...
This repository contains a Django Rest Framework (DRF) based project that simulates a restaurant's delivery network. The project is designed to manage various aspects of a restaurant's operations, including customer orders, delivery crew, and manager functionalities.
...
5. Install Django and other required packages:
   ...
   pip install djoser
   ```
  # "pip install django" for using python-django framework,"pip install  djangorestframework" for using django-restframework,
  # "pip install djangorestframework-xml" to make django rest framework support xml files, "pip install djoser" djoser provides basic login and logout pages.
